...
class Solr(Script):
    def install(self, env):
        ...
        Execute('cd ' + params.solr_dir + '; wget ' + params.solr_downloadlocation +' -O solr.tgz -o '+ params.solr_log, user=params.solr_user)
        Execute('cd ' + params.solr_dir + '; tar -xvf solr.tgz', user=params.solr_user)
        Execute('cd ' + params.solr_dir + '; ln -s solr-5.5.3 latest', user=params.solr_user)
